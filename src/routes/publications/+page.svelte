	...
	<ol class="px-3">
		...
		<details open>
			...
			<li class="ps-10">
				...
				<a
					class="text-link-active-color block underline"
			...
			<li class="ps-10">
				...
				<p>
					<a class="text-link-active-color underline" href="https://doi.org/10.1093/neuonc/noad018"
			...
			<li class="ps-10">
				...
				<p>
					<a
						class="text-link-active-color underline"
